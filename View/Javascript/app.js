...
(function() {
  var app = angular.module('GamingGen', ['ui.router', 'permission', 'permission.ui', 'AuthServices', 'AppControllers' ,'Socket', 'Slider', 'UserS', 'youtube-embed', 'angular-loading-bar', 'cfp.loadingBar', 'ngAnimate', 'infinite-scroll', 'ngImageAppear']);
